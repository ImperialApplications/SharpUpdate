...
namespace SharpUpdate2_0
{
    ...
    public class SharpUpdater
    {
        ...
        private readonly Uri UpdateXmlLocation = new Uri("https://raw.githubusercontent.com/ImperialApplications/SharpUpdate/main/update.xml");
        ...
        /// <summary>
        /// After the background worked is done, prompt to update if there is one
        /// </summary>
        ...
        /// <param name="applicationInfo">A SharpUpdateInfo object containing application's info</param>
